import logo from "./../../public/images/image-removebg-preview.png"; // Ensure to replace with your logo path
    ...
    <footer className="footer bg-white text-gray-800 p-10 flex flex-col items-center">
      <aside className="flex items-center mb-6">
        ...
        <p className="text-center  font-semibold">
          ...
          <br />
          Quality products at unbeatable prices since 2024.
        </p>
      </aside>
      <nav>
        ...
        <div className="grid grid-flow-col gap-6">
          <a href="#" aria-label="Twitter">
            ...
            <svg
              ...
              height="24"
              viewBox="0 0 24 24"
              className="fill-current text-gray-600 hover:text-gray-800 transition"
            >
